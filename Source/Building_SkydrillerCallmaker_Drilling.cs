...
namespace Industrialisation
{
    class Building_SkydrillerCallmaker_Drilling : Building
    {
        ...
        private static bool plasmaApplyDamageToExplosionCellsNeighbors = true;
        ...
        public override void Tick()
        {
            ...
            if (this.explosionTick == 0)
            {
                ...
                GenExplosion.DoExplosion(base.Position, base.Map, 1.5f, DamageDefOf.Flame, (Thing)null, plasmaDamage, 
