...
namespace Industrialisation
{
    public class PlaceWorker_OnMiningHole : PlaceWorker
    {
        ...
        public override AcceptanceReport AllowsPlacing(BuildableDef checkingDef, IntVec3 loc, Rot4 rot, Map map, Thing thingToIgnore = null, Thing thing = null)
        {
            ...
            Thing inspectedThing = map.thingGrid.ThingAt(loc, ThingDef.Named("Ind_MiningHole"));

            if (inspectedThing == null || inspectedThing.Position != loc)
            {
        ...
        //{
        //    return other == ThingDef.Named("Ind_MiningHole");
        //}
    }
}